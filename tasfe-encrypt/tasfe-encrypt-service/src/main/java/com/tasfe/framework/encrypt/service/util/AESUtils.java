package com.tasfe.framework.encrypt.service.util;
...
public class AESUtils {
    ...
    public static String encryptData(String key, String content) {
        ...
        try {
            ...
            return new String(Base64Utils.encode(encryptedBytes));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String decryptData(String key, String content) {
        try {
            // base64 解码
            byte[] encryptedBytes = Base64Utils.decode(content.getBytes());
            byte[] enCodeFormat = key.getBytes();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(AESUtils.encryptData("1111111111111111","lait.zhang"));

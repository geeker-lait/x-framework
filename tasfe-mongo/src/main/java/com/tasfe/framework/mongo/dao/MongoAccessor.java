package com.tasfe.framework.mongo.dao;

import com.mongodb.BasicDBList;
import com.mongodb.client.result.DeleteResult;
import com.mongodb.client.result.UpdateResult;
import com.tasfe.framework.mongo.pojo.MongoStatic;
import com.tasfe.framework.mongo.pojo.Page;
import com.tasfe.framework.mongo.pojo.PageParam;
...
/**
 * Mongo数据库 dao操作类，基于spring-data-mongodb 2.0.0.RELEASE版本
 * <p>
 * 官方文档：http://docs.spring.io/spring-data/data-mongo/docs/2.0.0.RELEASE/reference/html/
 * 官方API：http://docs.spring.io/spring-data/data-mongo/docs/2.0.0.RELEASE/api/
 * <p>
...
public abstract class MongoAccessor {
     ...
     * @return
     */
    public org.bson.Document runCommand(String json) {
    ...
    public long removeBean(Object removeBean) {
        DeleteResult deleteResult = mongoTemplate.remove(removeBean);
        long n = deleteResult.getDeletedCount();
    ...
    public long removeBeanByBeanAndCollectionName(Object removeBean, String collectionName) {
        DeleteResult deleteResult = mongoTemplate.remove(removeBean, collectionName);
        long n = deleteResult.getDeletedCount();
        LOG.info("- 删除所有匹配文档集合 ，满足的删除条数:" + n);
        return n;
    }

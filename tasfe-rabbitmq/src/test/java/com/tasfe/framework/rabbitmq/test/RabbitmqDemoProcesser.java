 ...
 */
public class RabbitmqDemoProcesser implements RabbitmqMessageProcesser<UserMessage> {
    public static void main(String args[]) {
        ClassPathXmlApplicationContext classPathXmlApplicationContext = new ClassPathXmlApplicationContext("mobanker-demo-rabbitmq-consumer.xml");
    }


    @Override
    public void processMessage(UserMessage userMessage) {
        System.out.printf("======" + userMessage.toString());
    }
